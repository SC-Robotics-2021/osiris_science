...
#ifndef PushButton_Plugin_1906257014_h
#define PushButton_Plugin_1906257014_h
...
namespace push_button_interface {
    namespace action {
        namespace dds_ {
            ...
            #define PushButton_Goal_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define PushButton_Goal_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define PushButton_Goal_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define PushButton_Goal_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define PushButton_Goal_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern PushButton_Goal_*
            ...
            PushButton_Goal_PluginSupport_copy_data(
                PushButton_Goal_ *out,
                const PushButton_Goal_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_Goal_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_Goal_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_Goal_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_Goal_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            PushButton_Goal_Plugin_new(void);

            NDDSUSERDllExport extern void
            PushButton_Goal_Plugin_delete(struct PRESTypePlugin *);
...
namespace push_button_interface {
    namespace action {
        namespace dds_ {
            ...
            #define PushButton_SendGoal_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define PushButton_SendGoal_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define PushButton_SendGoal_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define PushButton_SendGoal_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define PushButton_SendGoal_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern PushButton_SendGoal_Request_*
            ...
            PushButton_SendGoal_Request_PluginSupport_copy_data(
                PushButton_SendGoal_Request_ *out,
                const PushButton_SendGoal_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            PushButton_SendGoal_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_SendGoal_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_SendGoal_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_SendGoal_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_SendGoal_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            PushButton_SendGoal_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            PushButton_SendGoal_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace push_button_interface {
    namespace action {
        namespace dds_ {
            ...
            #define PushButton_SendGoal_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define PushButton_SendGoal_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define PushButton_SendGoal_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define PushButton_SendGoal_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define PushButton_SendGoal_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern PushButton_SendGoal_Response_*
            ...
            PushButton_SendGoal_Response_PluginSupport_copy_data(
                PushButton_SendGoal_Response_ *out,
                const PushButton_SendGoal_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            PushButton_SendGoal_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_SendGoal_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_SendGoal_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_SendGoal_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_SendGoal_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            PushButton_SendGoal_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            PushButton_SendGoal_Response_Plugin_delete(struct PRESTypePlugin *);
...
namespace push_button_interface {
    namespace action {
        namespace dds_ {
            ...
            #define PushButton_Result_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define PushButton_Result_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define PushButton_Result_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define PushButton_Result_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define PushButton_Result_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern PushButton_Result_*
            ...
            PushButton_Result_PluginSupport_copy_data(
                PushButton_Result_ *out,
                const PushButton_Result_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_Result_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_Result_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_Result_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_Result_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            PushButton_Result_Plugin_new(void);

            NDDSUSERDllExport extern void
            PushButton_Result_Plugin_delete(struct PRESTypePlugin *);
...
namespace push_button_interface {
    namespace action {
        namespace dds_ {
            ...
            #define PushButton_GetResult_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define PushButton_GetResult_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define PushButton_GetResult_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define PushButton_GetResult_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define PushButton_GetResult_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern PushButton_GetResult_Request_*
            ...
            PushButton_GetResult_Request_PluginSupport_copy_data(
                PushButton_GetResult_Request_ *out,
                const PushButton_GetResult_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            PushButton_GetResult_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_GetResult_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_GetResult_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_GetResult_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_GetResult_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            PushButton_GetResult_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            PushButton_GetResult_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace push_button_interface {
    namespace action {
        namespace dds_ {
            ...
            #define PushButton_GetResult_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define PushButton_GetResult_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define PushButton_GetResult_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define PushButton_GetResult_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define PushButton_GetResult_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern PushButton_GetResult_Response_*
            ...
            PushButton_GetResult_Response_PluginSupport_copy_data(
                PushButton_GetResult_Response_ *out,
                const PushButton_GetResult_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            PushButton_GetResult_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_GetResult_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_GetResult_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_GetResult_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_GetResult_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            PushButton_GetResult_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            PushButton_GetResult_Response_Plugin_delete(struct PRESTypePlugin *);
...
namespace push_button_interface {
    namespace action {
        namespace dds_ {
            ...
            #define PushButton_Feedback_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define PushButton_Feedback_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define PushButton_Feedback_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define PushButton_Feedback_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define PushButton_Feedback_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern PushButton_Feedback_*
            ...
            PushButton_Feedback_PluginSupport_copy_data(
                PushButton_Feedback_ *out,
                const PushButton_Feedback_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            PushButton_Feedback_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_Feedback_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_Feedback_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_Feedback_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_Feedback_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            PushButton_Feedback_Plugin_new(void);

            NDDSUSERDllExport extern void
            PushButton_Feedback_Plugin_delete(struct PRESTypePlugin *);
...
namespace push_button_interface {
    namespace action {
        namespace dds_ {
            ...
            #define PushButton_FeedbackMessage_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define PushButton_FeedbackMessage_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define PushButton_FeedbackMessage_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define PushButton_FeedbackMessage_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define PushButton_FeedbackMessage_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern PushButton_FeedbackMessage_*
            ...
            PushButton_FeedbackMessage_PluginSupport_copy_data(
                PushButton_FeedbackMessage_ *out,
                const PushButton_FeedbackMessage_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            PushButton_FeedbackMessage_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_FeedbackMessage_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_FeedbackMessage_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            PushButton_FeedbackMessage_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                PushButton_FeedbackMessage_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            PushButton_FeedbackMessage_Plugin_new(void);

            NDDSUSERDllExport extern void
            PushButton_FeedbackMessage_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* PushButton_Plugin_1906257014_h */
